  ...
  return (
    <div className={styles.search}>
      <div
        className={
          searchTutorial
            ? `${styles.search_video} ${styles.tutorial}`
            : styles.search_video
        }
      >
        {searchTutorial == false ? (
          ...
          <div className={`${styles.search_video_tutorial}`}>
        ...
        <svg
          ref={offerSvgRef}
          onClick={(e) => {
            !offerTutorial && setShowOffer(!showOffer);
            setSearchVis(false);
            setShowOffer(true);
          }}
          className={styles.offer_svg}
          fill="#ffffff"
          height="200px"
          width="200px"
          version="1.1"
      ...
      >
        ...
        {showOffer && offerVideos.length == 0 && (
          <div
            ref={offerRef}
            className={`${styles.offer_videos_list} ${styles.empty}`}
          >
            <svg
              fill="#000000"
              viewBox="0 0 30 30"
